...
The author of this repo has been struggling to taxonomize the related topics, since there are so many perspeictives to follow, such as task-oriented, technique-oriented, and metaphysics-oriented. Finally the author desided to focus on the perspective of ***The Science of Intelligence***---each topic describes a phenomenon of intelligence, or an intelligent behavior---they are our objectives to reverse-engineer from human intelligence for computational methods. These topics are never restricted to specific technical methods or tasks, but are trying to categorize the essence of intelligence---from both *the software perspective* and *the hardware perspective*.
